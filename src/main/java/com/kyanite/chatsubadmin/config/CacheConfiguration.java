package com.kyanite.chatsubadmin.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kyanite.chatsubadmin.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kyanite.chatsubadmin.repository.UserRepository.USERS_BY_EMAIL_CACHE);
